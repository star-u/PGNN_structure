...
class WillowObject(BaseDataset):
    def __init__(self, sets, obj_resize):
        ...
        self.sets = sets
        self.classes = cfg.WillowObject.CLASSES[sets]
        
        self.kpt_len = [cfg.WillowObject.KPT_LEN for _ in cfg.WillowObject.CLASSES[sets]]

        self.root_path = Path(cfg.WillowObject.ROOT_DIR)
        self.obj_resize = obj_resize


        self.split_offset = cfg.WillowObject.TRAIN_OFFSET
